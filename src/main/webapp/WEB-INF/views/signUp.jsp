...
<body>
  ...
  <div class="authentication-wrapper authentication-3">
    <div class="authentication-inner">
      ...
      <div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5" style="background-image: url('/resources/assets/img/bg/21.jpg');">
				...
				<c:forEach items="${allergins }" var="aller" varStatus="status">
					<div class="col-sm-2 btn-group">			               
		                 <label class="custom-control custom-checkbox m-0">
		                    <input type="checkbox" name="allergy" value="${aller.code }" class="custom-control-input">
		                  <span class="custom-control-label">${aller.name }</span>	             
		                 </label>
		             </div>
		        </c:forEach> 	           	       		               
            </div> 		
              <button type="button" id="submitBtn" class="btn btn-primary btn-block mt-4">Sign Up</button>
              <div class="text-light small mt-4">
                By clicking "Sign Up", you agree to our
                <a href="#">terms of service and privacy policy</a>. We’ll occasionally send you account related emails.
              </div>
            </form>
            <!-- / Form -->
