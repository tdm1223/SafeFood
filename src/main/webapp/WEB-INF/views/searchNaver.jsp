					...
					<li class="sidenav-item open"><a href="javascript:void(0)"
						...
						<ul class="sidenav-menu">
							<li class="sidenav-item open active"><a
								href="/food/searchNaver" class="sidenav-link"> <i
						...
						<div class="card">
					      <ul class="list-group list-group-flush">                 
					        <li class="list-group-item py-4">
					          <a target="_blank" href='`+this.link+`' class="text-big">`+this.title+`</a>
					          <div class="small mt-1">
					            <a href="#" class="text-success">`+this.bloggername+`</a>
					            &nbsp; <span class="text-muted">·</span> &nbsp;                       
					            <span class="text-muted">`+YMDFormatter(this.postdate)+`</span>
					          </div>
					          <div class="mt-2">
					           `+this.description+`
					          </div>                 
