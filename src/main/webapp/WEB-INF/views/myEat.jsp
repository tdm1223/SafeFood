...
function del(eno) {
	var count = prompt("몇개를 삭제하시겠습니까?");
	if(!count){
		count=1;
	}
	console.log(count);
	location.href = "/member/deleteEat?quan="+count+"&eno="+eno;
}
</script>
<meta charset="utf-8">
		...
		<div class="layout-inner">
			...
			<div id="layout-sidenav"
				...
				<ul class="sidenav-inner py-1">
					...
					<li class="sidenav-item open active"><a href="/member/myEat"
			...
			<div class="layout-container">
				...
				<div class="layout-content">
					...
					<div class="container-fluid flex-grow-1 container-p-y">
						...
						<h4 class="font-weight-bold py-3 mb-4">섭취목록</h4>
										...
										<c:forEach items="${eatList}" var="content">
											<tr>
												<td><img class="img-responsive"
													src="${content.food.imgurl1 }" alt="" width="50px"></td>
												<td><a href="/food/detail?code=${content.food.code }">${content.food.name}</a></td>
												<td>${content.food.calory }kcal</td>
												<td>${content.quan }개</td>
												<td>${content.edate }</td>
												<td><button type="button" class="btn btn-info"
														onclick="del(${content.eno})">삭제</button></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
